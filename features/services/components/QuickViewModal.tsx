      ...
      {room && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-2xl max-h-[90vh] bg-white z-50 overflow-y-auto shadow-2xl rounded-2xl"
          >
            {/* Close Button */}
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onClose}
              className="absolute top-6 right-6 bg-white/90 backdrop-blur p-2 rounded-full shadow-lg hover:bg-gray-100 transition z-10"
            >
              <X className="w-5 h-5" />
            </motion.button>
