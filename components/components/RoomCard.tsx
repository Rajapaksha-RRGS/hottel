...
interface Room {
  ...
  bedType: string;
  viewType: string;
  amenities: string[]; // මේක string array එකක් බව දැන් TypeScript දන්නවා
  description: string;
  maxGuests: number;
}
...
const amenityIcons = {
  ...
  Spa: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2m0 2c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8z" />
    </svg>
  ),
  Sauna: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      <path d="M4 4h16v2H4V4zm2 6h12v10H6V10zm2 2v6h8v-6H8z" />
    </svg>
  ),
};
    ...
    >
      ...
      <div className="p-5 space-y-4">
        ...
        <p className="text-xs text-gray-500">
          ⭐ Perfect for up to {room.maxGuests}{" "}
